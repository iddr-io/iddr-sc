...
/**
 * @title SymetraXV2
 * @dev SymetraXV2 Token
 */
contract SymetraXV2 is Initializable, OwnableUpgradeable, PausableUpgradeable, BlacklistableUpgradeable , EIP712Upgradeable, UUPSUpgradeable {
    ...
    */
    function mint(address _to, uint256 _amount)
        ...
        whenNotPaused
        onlyMinters
        enforceCompliance(msg.sender)
        enforceCompliance(_to)
        returns (bool)
    {
